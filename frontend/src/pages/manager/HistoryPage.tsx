...
const INITIAL_FILTERS: Filters = { from: '', to: '', type: '', customerId: '', page: 1, limit: 10 };
...
export default function ManagerHistoryPage() {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ['managerHistory', queryParams],
    queryFn: () =>
      api
  ...
  return (
    <AppShell pageTitle="Transaction History">
      <div data-testid="screen-manager-history" className="space-y-6">
        <div className="flex items-center justify-between">
          <h1 className="font-display text-xl font-semibold text-[#0F172A]">Transaction History</h1>
          <ExportMenu endpoint="/api/v1/manager/transactions/history" params={queryParams} testIdPrefix="manager-history" />
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 flex flex-wrap gap-4 items-end">
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              data-testid="manager-history-filter-from"
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              data-testid="manager-history-filter-to"
              className="border border-border-input rounded px-3 py-2 text-sm font-ui focus:outline-none focus:border-brand-primary"
            />
          </div>
          <div className="flex flex-col gap-1">
            ...
            <select
              ...
              data-testid="manager-history-filter-customer"
              className="border border-border-input rounded px-3 py-2 text-sm font-ui focus:outline-none focus:border-brand-primary"
            >
          ...
          <div className="flex flex-col gap-1">
            ...
            <select
              ...
              data-testid="manager-history-filter-type"
              className="border border-border-input rounded px-3 py-2 text-sm font-ui focus:outline-none focus:border-brand-primary"
            >
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          <HistoryTable items={data?.data ?? []} isLoading={isLoading} testIdPrefix="manager-history" />
          {data && data.total > 0 && (
            <Pagination
              page={data.page}
